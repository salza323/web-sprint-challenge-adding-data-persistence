...
<!-- Everything that I have read leads me to believe that SQL ARE relational db.  -->

2. Why do tables need a `primary key`?
<!-- We must have an identifier that is autoincremeneting and can not be chamges by the client.  -->

3. What is the name given to a table column that references the primary key on another table.
<!-- Foreign Key -->

4. What do we need in order to have a _many to many_ relationship between two tables.
<!-- many columns relating to many columns -->
